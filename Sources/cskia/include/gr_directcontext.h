...
SK_C_API void gr_directcontext_flush_and_submit(gr_directcontext_t* self, gr_sync_cpu sync_cpu);
SK_C_API void gr_directcontext_flush_and_submit_with_surface(gr_directcontext_t* self, sk_surface_t* surface, gr_sync_cpu sync_cpu);
...
SK_C_API void gr_directcontext_purge_unlocked_resources(gr_directcontext_t* self, gr_purge_resource_options scratch_resources_only);
...
SK_C_API bool gr_directcontext_submit(gr_directcontext_t* self, gr_sync_cpu sync_cpu);
