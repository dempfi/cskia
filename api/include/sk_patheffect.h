...
SK_C_API sk_patheffect_t*
sk_patheffect_make_1dpath(const sk_path_t* path, float advance, float phase, sk_patheffect1dstyle_t style);
...
SK_C_API void sk_patheffect_unref(sk_patheffect_t* self);
