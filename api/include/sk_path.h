...
SK_C_API void sk_path_add_path_matrix(sk_path_t *path, sk_path_t *other, const sk_matrix_t *matrix, sk_path_add_mode_t add_mode);
...
SK_C_API sk_string_t *sk_path_to_svg_string(const sk_path_t *cpath);
...
SK_C_API void sk_pathmeasure_destroy(sk_pathmeasure_t *measure);
SK_C_API void sk_pathmeasure_set_path(sk_pathmeasure_t *measure, const sk_path_t *path, bool forceClosed);
SK_C_API float sk_pathmeasure_get_length(sk_pathmeasure_t *measure);
SK_C_API bool sk_pathmeasure_get_pos_tan(sk_pathmeasure_t *measure, float distance, sk_point_t *position, sk_vector_t *tangent);
SK_C_API bool sk_pathmeasure_get_matrix(sk_pathmeasure_t *measure, float distance, sk_matrix_t *matrix, sk_pathmeasure_matrixflags_t flags);
SK_C_API bool sk_pathmeasure_get_segment(sk_pathmeasure_t *measure, float start, float stop, sk_path_t *dst, bool startWithMoveTo);
SK_C_API bool sk_pathmeasure_is_closed(sk_pathmeasure_t *measure);
SK_C_API bool sk_pathmeasure_next_contour(sk_pathmeasure_t *measure);
