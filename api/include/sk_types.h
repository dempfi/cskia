...
#ifndef SK_IMPLEMENTATION
#define SK_IMPLEMENTATION 0
#endif

#ifndef SK_C_API
#ifdef SK_DLL
#ifdef _WIN32
#if SK_IMPLEMENTATION
...
typedef enum {
  ALL_GR_PURGE_RESOURCE_OPTIONS,
  SCRATCH_RESOURCES_ONLY_GR_PURGE_RESOURCE_OPTIONS,
} gr_purge_resource_options;
