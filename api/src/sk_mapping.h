...
SK_DEF_CLASS_MAP(SkFontStyleSet, sk_fontstyleset_t, FontStyleSet)
...
SK_DEF_CLASS_MAP(SkPDF::DateTime, sk_datetime_t, DateTime)
...
SK_DEF_ENUM_MAP(GrPurgeResourceOptions, gr_purge_resource_options, GrPurgeResourceOptions)
