...
static_assert(static_cast<int>(GrPurgeResourceOptions::kAllResources) == static_cast<int>(ALL_GR_PURGE_RESOURCE_OPTIONS), "");
static_assert(static_cast<int>(GrPurgeResourceOptions::kScratchResourcesOnly) == static_cast<int>(SCRATCH_RESOURCES_ONLY_GR_PURGE_RESOURCE_OPTIONS), "");

// GrSyncCpu
static_assert(static_cast<int>(GrSyncCpu::kYes) == static_cast<int>(YES_GR_SYNC_CPU), "");
static_assert(static_cast<int>(GrSyncCpu::kNo) == static_cast<int>(NO_GR_SYNC_CPU), "");
#endif
