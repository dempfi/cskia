...
sk_blendmode_t sk_paint_get_blendmode(sk_paint_t* self) {
  return ToBlendMode(AsPaint(self)->getBlendMode_or(SkBlendMode::kSrcOver));
};

void sk_paint_set_blendmode(sk_paint_t* self, sk_blendmode_t blendmode) {
  AsPaint(self)->setBlendMode(AsBlendMode(blendmode));
};
